...
date: "2026-02-19"
description: "Почему пет-проекты не доходят до релиза и что делать: время, продакшн, привычка. Кратко и по делу."
cover:
...
Советы тут простые, но от того не менее эффективные:

- Занимайтесь проектом понемногу, но стабильно. Поставьте себе задачу заниматься пет-проектом не менее N часов в неделю.
- Поручите рутинные задачи AI-агентам, чтобы не утомляться на бойлерплейте. Думайте над архитектурой, пишите задачи агенту и учитесь принимать результат правильно.
- Ведите список задач в репозитории. Я веду список фич в отдельном файле, где описываю задачи как Юзер-Стори с небольшим описанием. Выполненные задачи отмечаю галочкой, но не удаляю. Каждая такая фича легко становится вводным промптом для плана агенту.
- - Ведите документацию. Пытались решить какую-то проблему - запишите в доку. Нашли удобный скрипт для автоматизации - напишите инструкцию к нему. Представьте, что этой докой будет пользоваться человек, который вообще ничего не знает про проект. Могу заверить, что вы сами таким и будете, если делать перерывы в работе над петом.
